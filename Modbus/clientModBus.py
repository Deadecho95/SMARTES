...
class ClientModBus:
    ...
    """
        ...
        self.registers = [["Power_PvOnGrid_L1", 811, 100, 1], ["Power_PvOnGrid_L2", 812, 100, 1],
                          ...
                          ["Power_Grid_L3", 822, 100, 1], ["Voltage_Battery", 840, 100, 1/10],
                          ["Current_Battery", 841, 100, 1], ["Power_Battery", 842, 100, 1],
                          ["Percent_Soc_Battery", 843, 100, 1], ["State_Battery", 844, 100, 1],
                          ["Amphours_Consumed_Battery", 845, 100, 1],
                          ["Sec_TimeToGo_Battery", 846, 100, 1], ["Alarms_High_Temperature", 34, 242, 1],
                          ...
                          ["Percent_Max_Discharge", 2702, 100, 1]]  # Name, Register, unit ID
