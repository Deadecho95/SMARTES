...
class ClientModBus:
    ...
    """
        ...
        self.registers = [["Power_PvOnGrid_L1", 811, 100, 1, "uint", 16], ["Power_PvOnGrid_L2", 812, 100, 1, "uint", 16],
                          ["Power_PvOnGrid_L3", 813, 100, 1, "uint", 16], ["Power_Consumption_L1", 817, 100, 1, "uint", 16],
                          ["Power_Consumption_L2", 818, 100, 1, "uint", 16], ["Power_Consumption_L3", 819, 100, 1, "uint", 16],
                          ["Power_Grid_L1", 820, 100, 1, "int", 16], ["Power_Grid_L2", 821, 100, 1, "int", 16],
                          ["Power_Grid_L3", 822, 100, 1, "int", 16], ["Power_Genset_L1", 823, 100, 1, "int", 16],
                          ["Power_Genset_L2", 824, 100, 1, "int", 16], ["Power_Genset_L3", 825, 100, 1, "int", 16],
                          ["Voltage_Battery", 840, 100, 0.1, "uint", 16],
                          ["Current_Battery", 841, 100, 0.1, "int", 16], ["Power_Battery", 842, 100, 1, "int", 16],
                          ["Percent_Soc_Battery", 843, 100, 1, "uint", 16], ["State_Battery", 844, 100, 1, "uint", 16],
                          ["Amphours_Consumed_Battery", 845, 100, 0.1, "uint", 16],
                          ["Sec_TimeToGo_Battery", 846, 100, 100, "uint", 16], ["Alarms_High_Temperature", 34, 242, 1, "uint", 16],
